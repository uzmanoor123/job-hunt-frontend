    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[#3D348B] font-semibold text-lg">
            Smart CV Analysis & Job Matching
          </h1>
        </div>

        <div className="flex items-center gap-4 ">
          <div className="flex items-center gap-3 bg-[#ECE9FF]   rounded-full px-4 py-2">
            <div className="w-7 h-7 rounded-full bg-[#3D348B] text-white flex justify-center items-center font-semibold">
              T
            </div>
