    ...
    <div className="bg-white border border-gray-200 rounded-3xl p-6 mt-7">
      ...
      <div className="mt-6">
        ...
        <p className="mt-3 text-[15px] leading-8 text-[#5D5D74]">
          ...
          development using HTML, CSS, JavaScript, MySQL and PHP. I have
          worked on academic projects focused on real-world problem solving
          and am eager to gain industry level experience and enhance my
          technical skills.
        </p>
      </div>
